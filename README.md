...
You may also zoom usin the [+] or [-] keys, this will make the chart larger, or smaller, and you may then use the scroll bars on the bottom and right side to set the position.
